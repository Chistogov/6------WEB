...
Рекомендую!</p>
				...
				<div class = "block2">
					...
					<?php
					require  'php/formgen.php';
					echo forms('php/testsql.php','input','','get');
					echo ends('label','Ваше имя');
					echo inputs('text', 'Name', '^[A-Za-z0-9_]{1,15}$', 'Имя', 'required');
					echo ends('label','Email');
					echo inputs('email', 'Email', '\S+@[a-z]+.[a-z]+', 'mail@mail.com', 'required');
					echo ends('label','Телефон');
					echo inputs('tel', 'Tel', '(\+?\d[- .]*){11}', '+7(___)__-__-___', '');
					echo ends('label','Когда вы желаете к нам обратиться?');
					echo ends('label','Дата');
					echo inputs('date', 'Date', '', '', '');
					echo ends('label','Дата');
					echo inputs('time', 'Time', '', '', '');
					echo button('submit', 'submit', 'Отправить заявку');
	...
	<footer>
		<div class = "mid">	
			2016 Лабораторная работа №4 АСУ-13 Чистогов Максим  <a href="admin.php">admin</a>
		</div>
	</footer>
</body>
</html>